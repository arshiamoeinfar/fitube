...
export default function Comments({ isShowTitleRight }) {
  return (
                  ...
                  <div className="d-flex flex-column align-items-center items-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-full overflow-hidden">
                      <img
                        ...
                        className="img-comment-customer w-full h-full object-cover rounded-circle"
                        alt={testimonial.name}
                      />
                    </div>
                    <div className="d-flex flex-column items-start space-y-1">
                      <span className="customer-name font-bold  text-center">
                        {testimonial.name}
                      </span>
                      <span className="customer-course font-semibold text-center">
                        {testimonial.course}
                      </span>
                    </div>
                  </div>
