...
const Header = () => {
  ...
  return (
    <Navbar id="navbar" className="container-fluid px-3 mx-auto ">
      {
        isShowSerachBox ? (
          <div className="search-box w-100 d-flex justify-content-between align-items-center icon-close-searchBox">
            <input type="text" placeholder="نام دوره یا مقاله را وارد نمایید ..." className="form-control" />
            <button className="btn btn-danger"><CloseIcon/></button>
          </div>
        ):(
        ...
        <div className="row d-flex justify-content-between align-items-center w-100">
          ...
          <div className="col-4">
            <div className="utility-bar d-flex justify-content-between align-items-center">
              ...
              <div className="_icon_Navbar" onClick={() => setIsShowSerachBox(true)}>
